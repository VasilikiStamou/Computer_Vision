...
noi = [10:5:50]; %number or iterations
...
for i = 1:length(nol)
    for j = 1:length(noi)
        ...
        [results,results_lk,MSE,rho,MSELK] = ecc_lk_alignment ...
            (img_h_1,temp_h_1,i,j,'affine',eye(2,3));
        t_high1(i,j) = toc;
        ...
        tic;
        [results,results_lk,MSE,rho,MSELK] = ecc_lk_alignment ...
            (img_h_2,temp_h_2,i,j,'affine',eye(2,3));
        t_high1(i,j) = toc;
        ...
        tic;
        [results,results_lk,MSE,rho,MSELK] = ecc_lk_alignment ...
            (img_l_1,temp_l_1,i,j,'affine',eye(2,3));
        t_low1(i,j) = toc;
        ...
        tic;
        [results,results_lk,MSE,rho,MSELK] = ecc_lk_alignment ...
            (img_l_2,temp_l_2,i,j,'affine',eye(2,3));
        t_low2(i,j) = toc;
...
semilogy(xvector,t_high1(1,:),xvector,t_high2(1,:),...
    ...
    xvector,t_low1(2,:),xvector,t_low2(2,:));
ylabel('Time(sec.)');
xlabel('Number of Iterations');
...
legend(sprintf('High\\_1\\_nol:%d',1),...
    ...
    sprintf('High\\_1\\_nol:%d',2),...
    sprintf('High\\_2\\_nol:%d',2),...
    sprintf('Low\\_1\\_nol:%d',2),...
    sprintf('Low\\_2\\_nol:%d',2));
